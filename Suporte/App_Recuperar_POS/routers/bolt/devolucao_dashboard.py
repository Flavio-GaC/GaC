...
from themes.theme import cabecalho_pagina, kpi, badge, campo, estado_vazio, titulo_secao
...
def mostrar_dashboard(supabase):
    ...
    if buscar:
        with st.spinner("Buscando dados..."):
            try:
                # O banco estava usando "data_hora", mantido da regra original
                ...
                if dados:
                    ...
                    valor_acumulado = sum((int(l.get("qtd") or 0) * float(l.get("valor_reais") or 0)) for l in dados)
