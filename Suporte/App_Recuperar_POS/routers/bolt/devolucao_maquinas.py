...
def mostrar_devolucao(supabase):
    cabecalho_pagina(
        ...
        "Preencha os dados abaixo para gerar o registro e o texto de comunicação ao cliente.",
    )
    ...
    with st.container(border=True):
        ...
        # O tipo fica FORA do form para permitir a reatividade na tela
    ...
    with st.form("form_nova_devolucao", clear_on_submit=True):
        ...
        with col1:
            ...
            # A reatividade perfeita aqui dependeria do st.session_state, mas mantive a regra original
        ...
        st.caption("Campos com * são obrigatórios. Data/Hora e Criado Por são preenchidos automaticamente pelo sistema.")
        st.write("")
